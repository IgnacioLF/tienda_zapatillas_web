    ...
    <div className="text-white max-w-[16rem]">
      ...
      <div className="mt-1 ml-4 mr-3">
        ...
        <div className="flex justify-between items-center">
          ...
          <a
            onClick={() => alert("TODO")}
            className="font-semibold rounded-lg px-1 py-[0.1rem] bg-cyan-500 border-2 bg-origin-border border-transparent hover:border-2 hover:border-white hover:text-gray-300"
          >
            Ver detalles
          </a>
        </div>
